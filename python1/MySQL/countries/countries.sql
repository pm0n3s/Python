...
-- should arrange the result by the number of cities in descending order. (3)
...
-- district and have the population greater than 500, 000? The query should return the Country 
-- Name, City Name, District and Population. (2)
...
SELECT countries.region AS region, COUNT(countries.id)
FROM countries
